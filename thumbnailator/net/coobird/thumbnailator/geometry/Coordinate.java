...
/**
 * This class calculates the position of an image which is to be enclosed, using
 * an absolute coordinate at which the image should be located.
 * 
 * @author coobird
 *
 */
public final class Coordinate implements Position {
	 ...
	 * 
	 * @param x
	 *            The horizontal component of the top-left corner of the image
	 *            to be enclosed.
	 * @param y
	 *            The vertical component of the top-left corner of the image to
	 *            be enclosed.
	 */
