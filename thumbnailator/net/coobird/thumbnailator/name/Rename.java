...
public abstract class Rename {
	 ...
	 *             {@link Rename#PREFIX_HYPHEN_THUMBNAIL}. This constant will be
	 *             removed in Thumbnailator 0.5.0.
	 */
	@Deprecated
	...
	/**
	 * Appends {@code .thumbnail} to the file name prior to the extension of the
	 * file.
	 * <p>
	 * Note: The {@link #apply(String, ThumbnailParameter)} method does not use
	 * the {@code param} parameter. A value of {@code null} for {@code param} is
	 ...
	 * 
	 * @deprecated Please use the correctly spelled
	 *             {@link Rename#SUFFIX_HYPHEN_THUMBNAIL}. This constant will be
	 *             removed in Thumbnailator 0.5.0.
	 */
	@Deprecated
	...
	/**
	 * The default constructor is intended only to be called implicitly by the
	 * classes implementing the functionality of the {@link Rename} class.
	 */
	protected Rename() {
	}

	/**
	 * Applies the function performed by this {@code Rename} on the specified
	 * name and thumbnail creation parameters.
	 * 
	 * @param name
	 *            Name to apply the function on. <em>The file name should not
	 *            include the directory in which the file resides in.</em>
	 * @param param
	 *            Parameters used to create the thumbnail.
