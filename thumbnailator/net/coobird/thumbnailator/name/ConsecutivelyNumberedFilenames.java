...
/**
 * This class is used to produce file names based on a given format string and
 * an internal counter which increments every time a new file name is produced.
 * 
 * @author coobird
 *
 */
public class ConsecutivelyNumberedFilenames implements Iterable<File> {
	 ...
	 * <p>
	 * <h3>File name sequence</h3> For a case where the given value is
	 * {@code 5}:
	 * <ol>
	 * <li><code>5</code></li>
	 * <li><code>6</code></li>
	 ...
	 * <p>
	 * <h3>File name sequence</h3> For a case where the parent directory is
	 * {@code /foo/bar/}:
	 * <ol>
	 ...
	 * @throws IOException
	 *             If the specified directory path is not a directory, or if
	 *             does not exist.
	 */
	 ...
	 * replaced with a consecutively counted number. Additional formatting can
	 * be applied. For more details, please refer to the section on
	 * <em>Numeric</em> formatting in the Java API specification for the
	 * {@link Formatter} class.
	 * <p>
	 * <h3>File name sequence</h3> For a case where the format string is
	 * {@code image-%d}:
	 * <ol>
	 ...
	 * <p>
	 * <h3>File name sequence</h3> For a case where the parent directory is
	 * {@code /foo/bar/}, and the specified value is {@code 5}:
	 * <ol>
	 ...
	 * <p>
	 * <h3>File name sequence</h3> For a case where the parent directory is
	 * {@code /foo/bar/}, with the format string {@code image-%d}:
	 * <ol>
	 ...
	 * <p>
	 * <h3>File name sequence</h3> For a case where the parent directory is
	 * {@code /foo/bar/}, and the specified value is {@code 5}, with the format
	 * string {@code image-%d}:
	 * <ol>
	 ...
	 * <p>
	 * <h3>File name sequence</h3> For a case where the parent directory is
	 * {@code /foo/bar/}, and the specified value is {@code 5}, with format
	 * string {@code image-%d}:
	 * <ol>
