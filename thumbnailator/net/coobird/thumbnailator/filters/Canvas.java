...
/**
 * An {@link ImageFilter} which will enclose an image into a specified enclosing
 * image.
 * <p>
 * The intended use of this {@code ImageFilter} is to take an image and place it
 * inside of a larger image, creating a border around the original image. This
 * can be useful when the dimensions of a thumbnail must always be the same
 * dimensions, and the original images are of differing dimensions.
 * <p>
...
public class Canvas implements ImageFilter {
	 ...
	 * @param position
	 *            The position to place the enclosed image.
	 */
	 ...
	 *            The position to place the enclosed image.
	 * @param crop
	 *            Whether or not to crop the enclosed image if the enclosed
	 *            image has dimensions which are larger than the specified
	 ...
	 *            The position to place the enclosed image.
	 * @param fillColor
	 *            The color to fill portions of the image which is not covered
	 *            by the enclosed image. Portions of the image which is
	 *            transparent will be filled with the specified color as well.
	 */
