...
public class Transparency implements ImageFilter {
	 ...
	 * 
	 * @param alpha
	 *            The opacity of the resulting image. The value should be
	 *            between {@code 0.0f} (transparent) to {@code 1.0f} (opaque),
	 *            inclusive.
	 * @throws IllegalArgumentException
	 *             If the specified opacity is outside of the range specified
	 *             above.
	 */
