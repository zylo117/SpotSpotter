...
public class Rotation {
	...
	/**
	 * Creates a new instance of {@code Rotator} which rotates an image at the
	 * specified angle.
	 * <p>
	 ...
	 * 
	 * @param angle
	 *            The angle at which the instance of {@code Rotator} is to
	 *            rotate a image it acts upon.
	...
	public static Rotator newRotator(final double angle) {
		Rotator r = new Rotator() {
			...
			public BufferedImage apply(BufferedImage img) {
				...
				/*
				 * TODO consider RenderingHints to use. The following are hints
				 * which have been chosen to give decent image quality. In the
				 * future, there may be a need to have a way to change these
				 * settings.
				 */
