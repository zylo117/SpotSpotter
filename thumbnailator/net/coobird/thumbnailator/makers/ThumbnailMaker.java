...
public abstract class ThumbnailMaker {
	...
	protected final static class ReadinessTracker {
		 ...
		 * 
		 * @return {@code true} if the {@link ThumbnailMaker} is ready to make
		 *         thumbnails, {@code false} otherwise.
		 */
		 ...
		 * 
		 * @param parameterName
		 *            The parameter which has not been set.
		 */
		 ...
		 * 
		 * @param parameterName
		 *            The parameter to be marked as being set.
		 */
		 ...
		 * 
		 * @param parameterName
		 *            The parameter to check whether it has been already set or
		 *            not
	...
	/**
	 * Object used to keep track whether the required parameters for creating a
	...
	/**
	 * The {@link ResizerFactory} which is used to obtain a {@link Resizer} for
	 * the resizing operation.
	 * <p>
	 * By delaying the decision of picking the {@link Resizer} to use until when
	 * the thumbnail is to be created could lead to a more suitable
	 ...
	 * @param img
	 *            The source image.
	 * @return The thumbnail created from the source image, using the parameters
	 *         set by the {@link ThumbnailMaker}.
	 */
	public abstract BufferedImage make(BufferedImage img);

	/**
	 * Makes a thumbnail of the specified dimensions, from the specified source
	 * image.
	 * 
	 * @param img
	 *            The source image.
	 * @param width
	 *            The target width of the thumbnail.
	 * @param height
	 *            The target height of the thumbnail.
	 * @return The thumbnail image.
	 * @throws IllegalStateException
	 *             If the {@code ThumbnailMaker} is not ready to create
	 *             thumbnails.
	 * @throws IllegalArgumentException
	 *             If the width and/or height is less than or equal to zero.
	 */
	 ...
	 * 
	 * @param imageType
	 *            The type of the {@code BufferedImage}.
	 ...
	 * 
	 * @param resizer
	 *            The {@link Resizer} to use when resizing the image to create
	 *            the thumbnail.
	 * @return A reference to this object.
	 */
	 ...
	 *            The {@link ResizerFactory} to obtain the {@link Resizer} used
	 *            when resizing the image to create the thumbnail.
	 * @return A reference to this object.
	 * @since 0.4.0
	 */
