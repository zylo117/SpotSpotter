 ...
 * {@code 0}, then that dimension will be promoted to {@code 1}. This will cause
 * some resizing operations to not preserve the aspect ratio of the original
 * image.
 * <p>
 * <DL>
 * <DT><B>Usage:</B></DT>
 * <DD>The following example demonstrates how to create a thumbnail which is 25%
 ...
 * </DD>
 * </DL>
 * It is also possible to independently specify the scaling factor for the width
 * and height. (If the two scaling factors are not equal then the aspect ratio
 * of the original image will not be preserved.)
 * <p>
 * <DL>
 * <DT><B>Usage:</B></DT>
 * <DD>The following example demonstrates how to create a thumbnail which is
 * scaled 50% in the width and 75% in the height:
 * 
 * <pre>
 * BufferedImage img = ImageIO.read(new File("sourceImage.jpg"));
 * BufferedImage thumbnail = new ScaledThumbnailMaker().scale(0.50, 0.75).make(img);
 * </pre>
 * 
 * </DD>
 * </DL>
...
public final class ScaledThumbnailMaker extends ThumbnailMaker {
	...
	/**
	 * The scaling factor to apply to the width when resizing an image to create
	 * a thumbnail.
	 */
	...
	/**
	 * <p>
	 * Creates an instance of {@code ScaledThumbnailMaker} without the scaling
	 * factor specified.
	 * </p>
	 * <p>
	 * To use this {@code ScaledThumbnailMaker}, one must specify the scaling
	 * factor to use by calling the {@link #scale(double)} method before
	 ...
	 * 
	 * @param factor
	 *            The scaling factor to apply when resizing an image to create a
	 *            thumbnail.
	 */
	 ...
	 * 
	 * @param widthFactor
	 *            The scaling factor to apply to the width when resizing an
	 *            image to create a thumbnail.
	 * @param heightFactor
	 *            The scaling factor to apply to the height when resizing an
	 *            image to create a thumbnail.
	 * @since 0.3.10
	 */
	 ...
	 *             If the scaling factor has already been previously set.
	 */
