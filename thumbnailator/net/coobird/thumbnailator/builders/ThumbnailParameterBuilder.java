 ...
 * <p>
 * The default values assigned to the {@link ThumbnailParameter} created by the
 * {@link ThumbnailParameterBuilder} are as follows:
 * <p>
 * <dl>
 * <dt>width</dt>
 ...
 * <dt>output format</dt>
 * <dd>See {@link ThumbnailParameter#ORIGINAL_FORMAT}. Maintains the same image
 * format as the original image.</dd>
...
public final class ThumbnailParameterBuilder {
	 ...
	 *             If the widht or height is less than 0.
	 */
	 ...
	 * @return A reference to this object.
	 * @throws IllegalArgumentException
	 *             If the scaling factor is not a rational number, or if it is
	 *             less than {@code 0.0}.
	 */
	 ...
	 *            The scaling factor to use for the width when creating the
	 *            thumbnail.
	 * @param heightScalingFactor
	 *            The scaling factor to use for the height when creating the
	 *            thumbnail.
	 * @return A reference to this object.
	 * @throws IllegalArgumentException
	 *             If the scaling factor is not a rational number, or if it is
	 ...
	 * 
	 * @param keep
	 *            {@code true} if the aspect ratio of the original image is to
	 *            be maintained in the thumbnail, {@code false} otherwise.
	 * @return A reference to this object.
	 */
	...
	/**
	 * Sets the {@link Resizer} to use when performing the resizing operation to
	 ...
	 *
	 * @param resizer
	 *            The {@link Resizer} to use when creating the thumbnail.
	 * @return A reference to this object.
	 */
	 ...
	 *            The {@link ResizerFactory} to use when obtaining a
	 *            {@link Resizer} to create the thumbnail.
	 * @return A reference to this object.
	 * @since 0.4.0
	 */
	 ...
	 * 
	 * @param fit
	 *            {@code true} if the thumbnail should be sized to fit within
	 *            the specified dimensions, if the thumbnail is going to exceed
	 *            those dimensions.
	 * @return A reference to this object.
	 * @since 0.4.0
	 */
	 ...
	 * 
	 * @param use
	 *            {@code true} if the Exif metadata should be used to determine
	 *            the orientation of the thumbnail, {@code false} otherwise.
	 * @return A reference to this object.
	 * @since 0.4.3
	 */
	 ...
	 * 
	 * @return A {@link ThumbnailParameter} with parameters set through the use
	 *         of this builder.
	 * @throws IllegalStateException
	 *             If neither the size nor the scaling factor has been set.
	 */
	public ThumbnailParameter build() {
		if (!Double.isNaN(widthScalingFactor)) {
			// If scaling factor has been set.
			return new ThumbnailParameter(widthScalingFactor, heightScalingFactor, sourceRegion, keepAspectRatio,
					thumbnailFormat, thumbnailFormatType, thumbnailQuality, imageType, filters, resizerFactory,
					fitWithinDimensions, useExifOrientation);

		} else if (width != UNINITIALIZED && height != UNINITIALIZED) {
			return new ThumbnailParameter(new Dimension(width, height), sourceRegion, keepAspectRatio, thumbnailFormat,
					thumbnailFormatType, thumbnailQuality, imageType, filters, resizerFactory, fitWithinDimensions,
					useExifOrientation);
		} else {
