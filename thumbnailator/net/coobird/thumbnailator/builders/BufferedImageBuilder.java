...
public final class BufferedImageBuilder {
	/**
	 * The default image type of the {@link BufferedImage}s to be created by
	 * this builder.
	 */
	 ...
	 * 
	 * @param size
	 *            The size of the {@link BufferedImage} to build.
	 */
	 ...
	 *            The size of the {@link BufferedImage} to build.
	 * @param imageType
	 *            The image type of the {@link BufferedImage} to build.
	 */
	 ...
	 * 
	 * @param width
	 *            The width of the {@link BufferedImage} to build.
	 * @param height
	 *            The height of the {@link BufferedImage} to build.
	 */
	 ...
	 * 
	 * @return Returns a newly created {@link BufferedImage} from the parameters
	 *         set in the {@link BufferedImageBuilder}.
	 */
