...
public class URLImageSource extends AbstractImageSource<URL> {
	...
	/**
	 * Instantiates an {@link URLImageSource} with the URL from which the source
	 * image should be retrieved from.
	 * 
	 * @param url
	...
	/**
	 * Instantiates an {@link URLImageSource} with the URL from which the source
	 * image should be retrieved from, along with the proxy to use to connect to
