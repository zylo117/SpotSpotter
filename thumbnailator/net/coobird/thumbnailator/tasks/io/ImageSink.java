 ...
 * 
 * @param <T>
 *            The destination class to which the thumbnail is stored or written.
 *
 * @author coobird
 *
 */
public interface ImageSink<T> {
	 ...
	 * 
	 * @param img
	 *            The image to write or store.
	 * @throws IOException
	 *             When a problem occurs while writing or storing the image.
	 ...
	 * 
	 * @param format
	 *            File format with which to store the image.
	 */
	public void setOutputFormatName(String format);

	/**
	 * Sets the {@link ThumbnailParameter} from which to retrieve parameters to
	 * use when storing the image.
	 * 
	 * @param param
	 *            The {@link ThumbnailParameter} with image writing parameters.
	 */
	public void setThumbnailParameter(ThumbnailParameter param);

	/**
	 * Returns the output format to use from information provided for the output
	 * image.
	 * <p>
