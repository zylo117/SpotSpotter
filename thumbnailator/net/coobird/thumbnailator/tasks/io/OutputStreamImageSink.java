...
public class OutputStreamImageSink extends AbstractImageSink<OutputStream> {
	/**
	 * The {@link OutputStream} to which the thumbnail image is to be written
	 * to.
	 */
	 ...
	 *             If the {@link OutputStream} is {@code null}.
	 */
	 ...
	 *             {@link #setOutputFormatName(String)} method.
	 * @throws IOException
	 *             When a problem occurs while writing the image.
	 * @throws NullPointerException
	 *             If the image is {@code null}.
	 * @throws IllegalStateException
	 *             If the output format has not been set by calling the
	 *             {@link #setOutputFormatName(String)} method.
	 */
