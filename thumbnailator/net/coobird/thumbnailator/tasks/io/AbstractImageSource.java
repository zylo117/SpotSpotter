...
public abstract class AbstractImageSource<T> implements ImageSource<T> {
	 ...
	 * <p>
	 * This method should be used by implementation classes when returning the
	 * result of the {@link #read()} method, as shown in the following example
	 * code:
	 * 
	 * <pre>
	 ...
	 * @param returnValue
	 *            The return value of the {@link #read()} method.
