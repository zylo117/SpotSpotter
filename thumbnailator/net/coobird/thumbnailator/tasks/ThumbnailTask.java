 ...
 * 
 * @param <S>
 *            The class from which the image is retrieved or read.
 * @param <D>
 *            The class to which the thumbnail is stored or written.
 * 
 * @author coobird
 *
 */
public abstract class ThumbnailTask<S, D> {
	 ...
	 * <p>
	 * To be used for situtions where the output image format should be the same
	 * as the input image format.
	 */
	 ...
	 * @throws IOException
	 *             Thrown when an I/O problem occurs when reading from the image
	 *             source.
	 */
	/*
	 ...
	 *             When an image file which is to be read or written is
	 *             unsupported.
	 * @throws IOException
	 *             Thrown when an I/O problem occurs when writing the image.
	 */
