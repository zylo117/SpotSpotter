...
/**
 * A thumbnail generation task which streams data from an {@link InputStream} to
...
public class StreamThumbnailTask extends ThumbnailTask<InputStream, OutputStream> {
	 ...
	 * 
	 * @param param
	 *            The parameters to use to create the thumbnail.
	 * @param is
	...
	public StreamThumbnailTask(ThumbnailParameter param, InputStream is, OutputStream os) {
		super(param);
		this.task = new SourceSinkThumbnailTask<InputStream, OutputStream>(param, new InputStreamImageSource(is),
