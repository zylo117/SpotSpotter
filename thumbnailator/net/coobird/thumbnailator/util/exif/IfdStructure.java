...
/**
 * IFD structure as defined in Section 4.6.2 of the Exif Specification version
 * 2.3.
 * 
 * @author coobird
 *
...
public class IfdStructure {
	 ...
	 * 
	 * @return An integer representation of the tag element. Should be a value
	...
	/**
	 * Returns the count element in the IFD structure, indicating the number of
	 * values the value field..
	 * 
	 ...
	 * 
	 * @return Either the offset or value. The type of the returned value can be
	 *         determined by the return of the {@link #isOffset()} or
	 *         {@link #isValue()} method.
	 */
	...
	public boolean isValue() {
		 ...
		 * less than or equal to 4 bytes see "Value Offset" in Section 4.6.3 of
	 ...
	 * 
	 * @return {@code true} if the value returned by the
	 *         {@link #getOffsetValue()} method is a offset value, {@code false}
	 *         otherwise.
	 */
	 ...
	 * 
	 * @return {@code true} if the given object and this object is equivalent,
	...
	public String toString() {
		return "IfdStructure [tag=" + Integer.toHexString(tag) + ", type=" + type + ", count=" + count
