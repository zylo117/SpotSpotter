...
/**
 * Representation for the Orientation (Tag 274) in the Exif metadata, as defined
 * in Section 4.6.4 of the Exif Specification version 2.3.
 * 
 * @author coobird
 *
 */
public enum Orientation {
	 ...
	 * @return {@link Orientation} corresponding to the orientation value.
	 *         Return {@code null} if the given value does not correspond to a
	 *         valid {@link Orientation}.
	 */
