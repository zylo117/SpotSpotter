...
/**
 * This enum corresponds to the types of data present in an IFD, as defined in
 * Section 4.6.2 of the Exif Specification version 2.3.
 * 
 * @author coobird
 *
 */
public enum IfdType {
	...
	/**
	 * An 8-bit value containing a single 7-bit ASCII character. The final byte
	 * is NULL-terminated.
	 */
	ASCII(2, 1),
	...
	/**
	 * Two {@link #LONG} values, where the first {@code LONG} is the numerator,
	 * while the second {@code LONG} is the denominator.
	 */
