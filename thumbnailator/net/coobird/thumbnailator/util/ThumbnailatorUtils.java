...
public final class ThumbnailatorUtils {
	 ...
	 * 
	 * @return A {@link List} of supported output formats. If no formats are
	 ...
	 * output format.
	 * 
	 * @return A {@link List} of supported output formats types. If no formats
	 *         types are supported, or if compression is not supported for the
	 *         specified format, then an empty list is returned.
	 */
	 ...
	 * @return {@code true} if the format type is supported by the specified
	 *         supported format, {@code false} otherwise.
	 */
