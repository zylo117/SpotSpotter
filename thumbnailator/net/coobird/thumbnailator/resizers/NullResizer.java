...
public class NullResizer extends AbstractResizer {
	/**
	 * Instantiates the {@code NullResizer} which draws the source image at the
	...
	/**
	 * This constructor is {@code private} to prevent the rendering hints from
	 * being set, as this {@link Resizer} does not perform any resizing.
	 * 
