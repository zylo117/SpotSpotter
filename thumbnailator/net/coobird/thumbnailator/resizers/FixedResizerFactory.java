...
public class FixedResizerFactory implements ResizerFactory {
	...
	/**
	 * Creates an instance of the {@link FixedResizerFactory} which returns the
	 * speicifed {@link Resizer} under all circumstances.
	 * 
	 * @param resizer
	 *            The {@link Resizer} instance that is to be returned under all
	 *            circumstances.
	 */
