...
public abstract class AbstractResizer implements Resizer {
	 ...
	 *            The rendering hint value to use for the interpolation hint.
	 * @param hints
	 *            Other rendering hints to add.
	 */
	 ...
	 * <p>
	 * The keys and values used for the rendering hints are those defined in the
	 * {@link RenderingHints} class.
	 * 
	 * @see RenderingHints
