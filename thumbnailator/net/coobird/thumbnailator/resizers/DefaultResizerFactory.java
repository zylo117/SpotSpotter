 ...
 * <dd>The {@link Resizer}s returned by this {@link ResizerFactory} depends upon
 ...
 * </li>
 * <li>Both the width and height of the destination image is smaller in the
 * source image not by a factor larger than 2, via
 * {@link #getResizer(Dimension, Dimension)}
 * <ul>
 * <li>{@link BilinearResizer}</li>
 * </ul>
 * </li>
 ...
 * <DL>
 * <DT><B>Usage:</B></DT>
 * <DD>The following example code demonstrates how to use
 * {@link DefaultResizerFactory} in order to obtain the optimal {@link Resizer},
 * and using that in order to perform the resizing operation.
 * <p>
 * 
 * <pre>
