...
/**
 * This enum can be used to select a specific {@link Resizer} in order to
 * perform a resizing operation.
 * <p>
 * The instance held by a value of this enum is a single instance. When using
 * specific implementations of {@link Resizer}s, it is preferable to obtain an
 * instance of a {@link Resizer} through this enum or the
 ...
 * <DL>
 * <DT><B>Usage:</B></DT>
 * <DD>The following example code demonstrates how to use the {@link Resizers}
 * enum in order to resize an image using bilinear interpolation:
 * <p>
 * 
 * <pre>
...
public enum Resizers implements Resizer {
	...
	/**
	 * A {@link Resizer} which performs resizing operations using bilinear
	 * interpolation.
	 */
	BILINEAR(new BilinearResizer()),

	/**
	 * A {@link Resizer} which performs resizing operations using bicubic
	 * interpolation.
	 */
	BICUBIC(new BicubicResizer()),

	/**
	 * A {@link Resizer} which performs resizing operations using progressive
	 * bilinear scaling.
	 * <p>
