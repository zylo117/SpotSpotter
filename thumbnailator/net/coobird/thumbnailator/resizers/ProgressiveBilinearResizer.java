...
/**
 * A {@link Resizer} which performs resizing operations by using progressive
 * bilinear scaling.
 * <p>
 * The resizing technique used in this class is based on the technique discussed
 * in <em>Chapter 4: Images</em> of
 * <a href="http://filthyrichclients.org">Filthy Rich Clients</a> by Chet Haase
 * and Romain Guy.
 * <p>
 * The actual implemenation of the technique is independent of the code which is
...
public class ProgressiveBilinearResizer extends AbstractResizer {
	/**
	 * Instantiates a {@link ProgressiveBilinearResizer} with default rendering
	 * hints.
	 */
	 ...
	 * 
	 * @param hints
	 *            Additional rendering hints to apply.
	 */
	 ...
	 *             When the source and/or the destination image is {@code null}.
	 */
	@Override
	public void resize(BufferedImage srcImage, BufferedImage destImage) throws NullPointerException {
		...
		/*
		 * Determine the size of the first resize step should be. 1) Beginning
		 * from the target size 2) Increase each dimension by 2 3) Until
