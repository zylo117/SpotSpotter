 ...
 *         Description:
 * 
 *         examples: System.loadLibrary("opencv_java300"); Mat mat =
 *         Mat.eye(1000, 2000, CvType.CV_8UC3); String window_name = "mat"
 *         ImageGui ig = new ImageGui(mat,window_name); ig.imshow();
 *         ig.waitKey(0);
 *
 */
